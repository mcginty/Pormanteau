...
SWIGEXPORT void JNICALL Java_com_theveganrobot_cvcamera_jni_cvcameraJNI_Processor_1setupDescriptorExtractorMatcher(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2, jint jarg3) {
  Processor *arg1 = (Processor *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  ...
  arg3 = (int)jarg3; 
  (arg1)->setupDescriptorExtractorMatcher((char const *)arg2,arg3);
  if (arg2) jenv->ReleaseStringUTFChars(jarg2, (const char *)arg2);
}
